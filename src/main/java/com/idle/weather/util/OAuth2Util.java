...
public class OAuth2Util {
    ...
    public String getKakaoUserInformation(final String accessToken) throws BaseException {
...
//                        clientResponse -> Mono.just(new CommonException()))
                ...
                .toStream()
                .findFirst()
                .orElseThrow(() -> new BaseException(ErrorCode.AUTH_SERVER_USER_INFO_ERROR));
